...
// AbortiveClose tears down an established app-facing gVisor TCP endpoint with
// a reset. It is intentionally separate from Close, whose contract is orderly
// FIN teardown.
func (c *gTCPConn) AbortiveClose() error {
	c.ep.Abort()
	return nil
}
