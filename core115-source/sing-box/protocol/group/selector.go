...
// SelectionListener receives actual selector changes from all entrypoints, including Clash.
type SelectionListener interface{ OnSelectorChanged(selector, tag string) }
...
func (s *Selector) SelectOutbound(tag string) bool {
	...
	if listener := service.FromContext[SelectionListener](s.ctx); listener != nil {
		listener.OnSelectorChanged(s.Tag(), tag)
	}
