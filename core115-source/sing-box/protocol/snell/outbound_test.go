...
func TestQUICDestCacheRetainsAllEntriesUntilExpiry(t *testing.T) {
	// Allow bulk insertion under parallel full-suite CPU contention.
	outbound := &Outbound{quicDestCache: expiringmap.New[quicDestCacheKey, uint64](500 * time.Millisecond)}
...
func (*lazyPacketTestClient) SetKeepIdleConnections(bool) {}
func (*lazyPacketTestClient) CloseIdleConnections()       {}
