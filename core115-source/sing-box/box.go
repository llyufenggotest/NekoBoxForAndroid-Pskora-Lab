...
func New(options Options) (*Box, error) {
	...
	// An explicit disabled cache wins over the platform default. Short-lived
	// URL-test instances keep platform logging without opening the shared DB.
	if experimentalOptions.CacheFile != nil && experimentalOptions.CacheFile.Enabled != nil {
		needCacheFile = *experimentalOptions.CacheFile.Enabled
	} else {
		needCacheFile = options.PlatformLogWriter != nil
	}
	...
	networkManager.BindConnectionManager(connectionManager)
