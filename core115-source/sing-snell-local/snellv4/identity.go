...
// IdentityV2HeaderFromPSK derives the public OIX identity header from a Snell PSK.
...
// IdentityV2AuthTag binds the OIX identity to the TLS exporter and Snell salt.
