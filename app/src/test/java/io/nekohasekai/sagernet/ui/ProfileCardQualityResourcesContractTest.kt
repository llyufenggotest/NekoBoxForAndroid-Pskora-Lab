...
class ProfileCardQualityResourcesContractTest {
    ...
    fun compactActionsUseSmallerSingleColumnGlyphs() {
        ...
        assertEquals("10dp", byId.getValue("profile_speedometer").android("padding"))
        assertEquals("@drawable/bg_speed_test_press_feedback",
            byId.getValue("profile_speedometer").android("background"))
        assertEquals("44dp", byId.getValue("profile_speedometer").android("layout_width"))
        assertEquals("44dp", byId.getValue("profile_speedometer").android("layout_height"))
        assertEquals("10dp", byId.getValue("profile_speedometer").android("padding"))
