...
class NativeInterface : BoxPlatformInterface, NB4AInterface {
    ...
    override fun startDefaultInterfaceMonitor(listener: libcore.InterfaceUpdateListener) = networkMonitor.start(listener)
    override fun closeDefaultInterfaceMonitor(listener: libcore.InterfaceUpdateListener) = networkMonitor.close(listener)
    override fun networkInterfacesJSON(): String = networkMonitor.interfacesJSON()
