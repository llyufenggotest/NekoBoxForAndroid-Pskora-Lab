...
abstract class BoxInstance(
    ...
    suspend fun awaitLogWriters() {
        if (::processes.isInitialized) processes.awaitClosed()
        for (instance in externalInstances.values) (instance as? io.nekohasekai.sagernet.bg.proto.BoxInstance)?.awaitLogWriters()
    }
