...
class ServiceButton @JvmOverloads constructor(
    ...
    fun changeState(state: BaseService.State, previousState: BaseService.State, animate: Boolean) {
        ...
        backgroundTintList = android.content.res.ColorStateList.valueOf(
            androidx.core.content.ContextCompat.getColor(context, if (checked) R.color.lab_control_success_background else R.color.lab_control_idle_background)
        )
        imageTintList = android.content.res.ColorStateList.valueOf(
            androidx.core.content.ContextCompat.getColor(context, if (checked) R.color.lab_control_success_foreground else R.color.lab_control_idle_foreground)
        )
